...
class Prefix_Element_Test extends \Bricks\Element
{
    ...
    public function render()
    {
        ...
        // Add editable attribute for inline editing
        $content = !empty($this->settings['content']) ? $this->settings['content'] : esc_html__('Content goes here ..', 'bricks');
        echo sprintf(
            '<div contenteditable="true" data-bricks-editable="content">%s</div>',
            esc_html($content)
        );
